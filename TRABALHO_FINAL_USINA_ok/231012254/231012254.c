...
penalizações na avaliação em caso de deteccção de plágio.
*******************************************************************************/
...
listagem de usinas, ordenação de energia, entre outros.
*/
int main()
{
